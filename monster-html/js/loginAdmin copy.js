...
function signUp() {
    ...
    if (username && email && password && repass) {
        ...
        if (!passw.test(password)) {
            ...
            alert('Vui lòng nhập mật khẩu từ 6-20 kí tự và có ít nhất số, chữ thường và chữ hoa.')
            return false;
    ...
    for (var i in User) {
        if (document.getElementById("usernamed").value) {
            ...
            if (document.getElementById("usernamed").value == User[i].username) {
                ...
                // kiểm tra mã xác nhận được nhập từ người dùng
                if (num == x) {
                    var passNew = prompt("Bạn đã xác minh tài khoản thành công. Vui lòng đổi mật khẩu:", "Vui lòng nhập mật khẩu từ 6-20 kí tự và có ít nhất 1 số, 1 chữ thường và 1 chữ hoa.")
